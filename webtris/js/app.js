...
function resizeCanvases() {
    ...
    gameInitData.gameCanvas.width = Math.round(
        gameInitData.gameCanvas.height / 2
    );
    gameInitData.nextPieceCanvas.height =
        gameInitData.nextPieceCanvas.clientHeight;
    gameInitData.nextPieceCanvas.width =
        gameInitData.nextPieceCanvas.clientWidth;
}
